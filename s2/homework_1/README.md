...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA bakery_db TO app;

GRANT SELECT ON ALL TABLES IN SCHEMA bakery_db TO analyst;

GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA bakery_db TO app;
